...
class ALOS2_pre_post():
    ...
    def change_thresholding(self,threshold_value):
        ...
        in_list =  [str(self.directory)+'/'+str(self.project_name)+"/Results"+'/Change-CCRS.tif']
...
class ALOS2_post():
    ...
    def speckle_filtering(self,filter_size):
        ...
        print("Reprojecting in order to Final results to be in WGS84")
        in_list =  [str(self.directory)+'/'+str(self.project_name)+"/Post_Data/Processed"+'/Post_Mosaic_Spec_'+str(filter_size)+'.tif']
    ...
    def thresholding(self,filter_size,threshold_value):
        ...
        str(self.directory)+'/'+str(self.project_name)+"/Results"+'/'+'Post_Mosaic_Spec_'+str(filter_size)+'-CCRS.tif'
               
        threshold(str(self.directory)+'/'+str(self.project_name)+"/Results"+'/'+'Post_Mosaic_Spec_'+str(filter_size)+'-CCRS.tif',
                  str(self.directory)+'/'+str(self.project_name)+"/Results"+'/'+'T_'+str(threshold_value)+'.tif',
                  threshold_value)     
        print("Threshold has been applied.") 
